...
class AssertTest extends TestCase
{
    ...
    public function testAssertArraySubset(): void
    {
        $array = [
            'a' => 'product a',
            'b' => 'product b',
            'c' => ['a2' => 'product a2', 'b2' => 'product b2'],
            'd' => ['a2' => ['a3' => 'product a3', 'b3' => 'product b3']]
        ];

        $this->assertArraySubset(['a' => 'product a', 'c' => ['a2' => 'product a2']], $array);
        $this->assertArraySubset(['a' => 'product a', 'd' => ['a2' => ['b3' => 'product b3']]], $array);

        $arrayAccessData = new \ArrayObject($array);

        $this->assertArraySubset(['a' => 'product a', 'c' => ['a2' => 'product a2']], $arrayAccessData);
        $this->assertArraySubset(['a' => 'product a', 'd' => ['a2' => ['b3' => 'product b3']]], $arrayAccessData);
        ...
        try {
            $this->assertArraySubset(['d' => ['a2' => ['bad index' => 'product b3']]], $array);
        } catch (AssertionFailedError $e) {
            return;
        }
