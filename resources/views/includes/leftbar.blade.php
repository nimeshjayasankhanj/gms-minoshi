        ...
        <div class="sidebar-inner slimscrollleft">
            <div id="sidebar-menu">
                <ul>
                    ...
                    <li>
                        <a href="{{route('make-a-booking')}}" class="waves-effect"><i class="fa fa-book" aria-hidden="true"></i><span>Make an Invoice </span></a>
                    </li>
                    <li class="has_sub">
                        <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-book" aria-hidden="true"></i><span>Invoices<span
                                        class="pull-right"><i class="mdi mdi-chevron-right"></i></span> </span></a>
                        <ul class="list-unstyled">
                            <li>
                                <a href="{{route('pending-cus-works')}}"><span>Pending Orders</span></a>
                            </li>
                          
                            <li>
                                <a href="{{route('completed-cus-works')}}"><span>Completed Orders</span></a>
                            </li>
                    ...
                    <li class="has_sub">
                        <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-cubes"></i><span>Users<span
                          ...
                          <li>
                            <a href="view-customers" class="waves-effect"><span>View Customer</span></a>
                         </li>
                        </ul>
                    </li>
