                                        ...
                                        <td>
                                            ...
                                            <p>
                                                <button type="button"
                                                    ...
                                                    data-toggle="modal" data-id="{{ $customer->iduser_master }}"
...
<div class="modal fade" id="employeeModal" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="" method="post" enctype="multipart/form-data" action="{{ route('updateUser') }}"
                    id="updateUserId">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="fName" autocomplete="off" name="fName"
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="lName" autocomplete="off" name="lName"
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="contactNo" autocomplete="off" name="contactNo"
...
<div class="modal fade" id="passUpModal" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title mt-0">Update Password</h5>
                ...
                <div class="form-group">
                    ...
                    <div class="m-t-10">
                        <input type="password" name="compass" id="compass" class="form-control" required
                            data-parsley-equalto="#update_pass2" placeholder="Re-Type Password" />
                    </div>
                </div>
                <div class="form-group">

                    <button type="submit" class="btn btn-md btn-warning waves-effect " onclick="editPassword()">
