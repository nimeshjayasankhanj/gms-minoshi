                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="customer" id="customer">
                                        <option value="" selected> Customer
                                        </option>
                                        @if (isset($customers))
                                            @foreach ($customers as $customers)
                                                <option value="{{ "$customers->iduser_master" }}">
                                    ...
                                    @if (count($incomes) != 0)
                                        ...
                                        @foreach ($incomes as $income)
                                            <tr>
                                                ...
                                                <td>{{ str_pad($income->idinvoice, 5, '0', STR_PAD_LEFT) }}</td>
                                                <td>{{ str_pad($income->master_booking_idmaster_booking, 5, '0', STR_PAD_LEFT) }}
                                                </td>
                                                <td>{{ $income->date }}</td>

                                                <td>
                                                    {{ \App\User::find($income->customer)->first_name }}
                                                    {{ \App\User::find($income->customer)->last_name }}
                                                </td>

                                                <td>{{ number_format($income->invoice_total, 2) }}</td>
